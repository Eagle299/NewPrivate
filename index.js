...
┈┈╰┓┏━━┓┏╯
┈┈┈╰╯┈┈╰╯ Aman Gak Banh?
By : ${chalk.bold('Stars29#2309')} - Credit : Stars29 Dll.
`);

  const auth = rs.question('Masukin Auth Banh ');
  chalk.bgYellow.bold('Memulai');
  ...
  while (true) {
    ...
    if (!result) {
      ...
      chalk.bgRed.bold('Authnya Error/Expired Bang');
      break
